...
if __name__ == '__main__':
    ...
    # サイト回し
    scheduler.add_job(sb_h_day_shift.sb_h_all_do, 'cron', hour=6, minute=30, args=[27], max_instances=1,misfire_grace_time=60*60)
    scheduler.add_job(sb_h_day_shift.sb_h_all_do, 'cron', hour=8, minute=50, args=[18], max_instances=1,misfire_grace_time=60*60)
