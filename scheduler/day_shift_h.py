...
if __name__ == '__main__':
    ...
    scheduler.add_job(sb_h_all_do.sb_h_all_do, 'cron', hour=15, minute=50, args=[20], misfire_grace_time=60*60)
    scheduler.add_job(sb_h_all_do.sb_h_all_do, 'cron', hour=18, minute=0, args=[20], misfire_grace_time=60*60)
